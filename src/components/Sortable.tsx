...
export function SortablePriorityItem({
  ...
  const statusColors: Record<string, string> = { active: '#3b82f6', review: '#f59e0b', done: '#22c55e', blocked: '#ef4444', archived: '#78716c', draft: '#d946ef' }
  const statusLabel: Record<string, string> = { active: 'Active', review: 'In Review', done: 'Done', blocked: 'Blocked', archived: 'Archived', draft: 'Draft' }
  const isOverdue = (() => {
